...
import { ElPopper, ElPopperArrow } from '@ls-ui/components/popper';
import { isBoolean } from '@ls-ui/utils';
import { useDelayedToggle, useId, usePopperContainer } from '@ls-ui/hooks';
import { TOOLTIP_INJECTION_KEY } from './constants';
import { tooltipEmits, useTooltipModelToggle, useTooltipProps } from './tooltip';
import ElTooltipTrigger from './trigger.vue';
import ElTooltipContent from './content.vue';

import type { PopperInstance } from '@ls-ui/components/popper';
...
onDeactivated(() => open.value && hide()); // keep-alive 离开的事件
